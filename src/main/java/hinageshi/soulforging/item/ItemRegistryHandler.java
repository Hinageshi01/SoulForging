...
public class ItemRegistryHandler {
    ...
    public static final ItemArmor.ArmorMaterial SOUL_GOLD_ARMOR_MATERIAL=EnumHelper.addArmorMaterial("SOUL_GOLD", SoulForging.MODID + ":soul_gold",50, new int[] {5,7,9,5},9, SoundEvents.ITEM_ARMOR_EQUIP_GOLD,3);
